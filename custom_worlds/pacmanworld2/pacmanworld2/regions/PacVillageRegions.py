...
from .RegionBase import PacManWorld2Region
from .. import PacManWorld2World
from ..Rules import null
from ..locs import CellLocations as Cells, ScoutLocations as Scouts


def build_regions(level_name: str, world: PacManWorld2World) -> List[PacManWorld2Region]:
    multiworld = world.multiworld
    options = world.options
    player = world.player

    main_area = PacManWorld2Region("Main Area", player, multiworld, level_name, 50)
