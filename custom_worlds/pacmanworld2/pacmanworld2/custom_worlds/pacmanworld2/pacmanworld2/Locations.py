from .Types import LocData, LevelType
from typing import Dict, TYPE_CHECKING

if TYPE_CHECKING:
    from . import PacManWorld2World

def did_include_timetrials(world: "PacManWorld2World") -> bool:
    return bool(world.options.IncludeTimeTrials)

def did_avoid_early_bk(world: "PacManWorld2World") -> bool:
    return bool(world.options.AvoidEarlyBK)

def get_total_locations(world: "PacManWorld2World") -> int:
    total = 0
    for name in location_table:
        if not did_include_timetrials(world) and name in timetrial_locations:
            continue
